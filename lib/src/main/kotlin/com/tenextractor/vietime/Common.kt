...
object Common {
    /**
     * get_tone_mark_placement() function from vi-rs/src/editing.rs Get nth character to place tone
     * mark
     *
     * # Rules:
     ...
     * - 3. For vowel length 3 or vowel length 2 with a final consonant, put it on the second vowel
     * character
